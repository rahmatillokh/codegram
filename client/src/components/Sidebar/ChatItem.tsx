...
const ChatItem = ({ user }: { user: userProps }) => {
  ...
  return (
    <>
      <li
        onClick={handleClick}
        className="flex gap-3 cursor-pointer hover:bg-slate-300 dark:hover:bg-slate-700 p-5 rounded-lg"
      >
        ...
        <div className="flex flex-col justify-between">
          <h3 className="font-semibold text-black dark:text-gray-50 text-lg">
            {user?.name}
          </h3>
